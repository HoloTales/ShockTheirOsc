...
{
    Username = "Holotales",
    Name = "ShockTheirOsc(Custom)",
    Apikey = "56a58878-cce8-4008-ab83-03058d2d4b2f",
    Code = "2FD9A199B75",
    Op = PiShockOpEnum.Shock,
    Intensity = ConvertFloatToIntWithRange(vrcIntensity, 1, 100),
    Duration = ConvertFloatToIntWithRange(vrcDuration, 1, 15)
};*/
